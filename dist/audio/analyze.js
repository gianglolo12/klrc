...
function computeFrames(samples) {
...
function loadCache(sourceId) {
    ...
    try {
        ...
        if (!Array.isArray(parsed.frames) || parsed.bands !== BANDS)
            return null;
        return {
